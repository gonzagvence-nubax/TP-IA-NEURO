...
from jugar_1k_partidas import jugar_mil_partidas
import random
...
def sample_params():
    params = {
        "episodes": random.randint(1000, 3000),        
        "gamma": random.uniform(0.9, 0.99),           
        "epsilon_start": random.uniform(0.8, 1.0),    
        "epsilon_min": random.uniform(0.05, 0.2),     
        "epsilon_decay": random.uniform(0.99, 0.999), 
        "alpha": random.uniform(0.001, 0.003),         
        "batch_size": random.choice([32, 64, 128, 256]),   
        "memory_size": random.randint(500, 3000),   
        "target_update_every": random.randint(75, 150) 
    }
    return params
